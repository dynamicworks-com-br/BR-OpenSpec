...
// Fenced-code-block detection is single-sourced in ./code-fence.js; it is
// re-exported here so existing import sites (`requirement-blocks.ts`,
// `markdown-parser.ts`, `change-parser.ts`) keep working unchanged.
import { buildCodeFenceMask } from './code-fence.js';

export { buildCodeFenceMask };
