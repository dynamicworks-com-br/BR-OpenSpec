...
const ONBOARDING_COMMANDS: readonly OnboardingCommand[] = [
  { workflow: 'propose', command: '/opsx:propose', description: ONBOARDING_MESSAGES.describePropose },
  { workflow: 'new', command: '/opsx:new', description: ONBOARDING_MESSAGES.describeNew },
  { workflow: 'continue', command: '/opsx:continue', description: ONBOARDING_MESSAGES.describeContinue },
  { workflow: 'apply', command: '/opsx:apply', description: ONBOARDING_MESSAGES.describeApply },
];
