 ...
 * src/core/profile-sync-drift.ts (exported) and src/core/tools-manager.ts (local copy).
 */
 ...
 * Kimi Code, ForgeCode, Trae or Mistral Vibe) — so those skills never point
 * at commands that were not generated. When commands are generated, tools
 * where the command filename doubles as the command name (bob, oh-my-pi,
 * opencode, pi, qwen) use hyphen-based command references. All other cases
 * keep the default `/opsx:*` references.
 *
