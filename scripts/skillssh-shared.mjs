 ...
 * skills.sh copies stay byte-stable across BR-OpenSpec version bumps. The line
 * is meaningful only for skills that `openspec init` writes into a project; in
 * the standalone distribution it would just churn the files on every release.
 */
