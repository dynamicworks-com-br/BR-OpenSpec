# BR-OpenSpec Documentation

Welcome. This is the home for everything BR-OpenSpec.

BR-OpenSpec helps you and your AI coding assistant **agree on what to build before any code is written.** You describe the change, the AI drafts a short spec and a task list, you both look at the same plan, and then the work happens. No more discovering halfway through that the AI built the wrong thing.
...
That second one matters more than it looks. BR-OpenSpec has two halves: a command line tool you run in your terminal, and slash commands you give to your AI assistant. Knowing which is which saves you the most common moment of confusion.
...
**I have a big existing codebase.** You don't document all of it. [Using BR-OpenSpec in an Existing Project](existing-projects.md) shows how to start on real, brownfield code without boiling the ocean.
...
**I work on a team.** [BR-OpenSpec on a Team](team-workflow.md) shows how a change maps onto a branch and a pull request, and how teammates review a plan before the code.
...
| [BR-OpenSpec on a Team](team-workflow.md) | How changes fit branches, pull requests, and review |
| [Using BR-OpenSpec in an Existing Project](existing-projects.md) | Adopting BR-OpenSpec on a large brownfield codebase |
...
| [Supported Tools](supported-tools.md) | The 25+ AI tools BR-OpenSpec integrates with, and where files land |
...
```text
1. Install        npm install -g @dynamicworks/br-openspec@latest
...
- **GitHub Issues:** [github.com/dynamicworks-com-br/BR-OpenSpec/issues](https://github.com/dynamicworks-com-br/BR-OpenSpec/issues) for bugs and feature requests.
