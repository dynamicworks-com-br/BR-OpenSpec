...
This guide explains how BR-OpenSpec works after you've installed and initialized it. For installation instructions, see the [main README](../README.md#quick-start) or the [Installation guide](installation.md). New to the whole docs set? The [documentation home](README.md) maps everything.
...
- [Using BR-OpenSpec in an Existing Project](existing-projects.md) - Start on a large brownfield codebase
