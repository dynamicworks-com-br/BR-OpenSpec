...
sequenceDiagram
    ...
    participant CLI as BR-OpenSpec CLI
...
If you want explicit scaffold-and-build commands (`/opsx:new`, `/opsx:continue`, `/opsx:ff`, `/opsx:verify`, `/opsx:code-review`, `/opsx:bulk-archive`, `/opsx:onboard`), enable them with:
...
- [BR-OpenSpec on a Team](team-workflow.md) - How changes fit branches and pull requests
