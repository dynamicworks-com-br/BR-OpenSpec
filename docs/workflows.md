...
If you want explicit scaffold-and-build commands (`/opsx:new`, `/opsx:continue`, `/opsx:ff`, `/opsx:verify`, `/opsx:code-review`, `/opsx:sync`, `/opsx:bulk-archive`, `/opsx:onboard`), enable them with:
