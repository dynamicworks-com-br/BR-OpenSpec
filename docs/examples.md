...
Now read the plan. Open the proposal and the delta spec. This is the moment BR-OpenSpec is built for: catching a wrong assumption while it's still one paragraph, not 400 lines of code. Edit any artifact directly if something's off, then continue.
...
**When to use it:** you've installed BR-OpenSpec and want to *feel* the workflow on your own code, not a toy example.
...
AI:  Welcome to BR-OpenSpec! I'll walk you through a complete change
