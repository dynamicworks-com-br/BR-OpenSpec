...
describe('FeedbackCommand', () => {
  ...
  describe('gh CLI availability check', () => {
    it('should use which command on Unix/macOS platforms', async () => {
      ...
      mockExecFileSync.mockReturnValue('https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/123\n');
    ...
    it('should handle missing gh CLI with fallback', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/new')
      );
    });
  ...
  describe('successful feedback submission', () => {
    it('should submit feedback via gh CLI when authenticated', async () => {
      const issueUrl = 'https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/123';
    ...
    it('should preserve message and body whitespace in the issue body', async () => {
      const issueUrl = 'https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/124';
    ...
    it('should preserve the full message in the body and shorten a long title', async () => {
      ...
      mockExecFileSync.mockReturnValue('https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/125\n');
    ...
    it('should include metadata in issue body', async () => {
      ...
      mockExecFileSync.mockReturnValue('https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/126\n');
    ...
    it('should add feedback label to the issue', async () => {
      ...
      mockExecFileSync.mockReturnValue('https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/127\n');
  ...
  describe('error handling', () => {
    ...
    it('should handle quotes in title and body without escaping (no shell injection)', async () => {
      ...
      mockExecFileSync.mockReturnValue('https://github.com/dynamicworks-com-br/BR-OpenSpec/issues/128\n');
    ...
    it('should display formatted feedback with proper structure', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          'Título: Feedback: Generated workflows declare too few allowed tools, so…'
        )
      );
      expect(consoleLogSpy).toHaveBeenCalledWith(
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('## Detalhes\n\nTest body')
      );
    });
      ...
      const urlCall = consoleLogSpy.mock.calls.find((call: any[]) => {
        ...
        try {
          ...
          return (
            ...
            parsed.pathname === '/dynamicworks-com-br/BR-OpenSpec/issues/new'
          );
        } catch {
          return false;
        }
